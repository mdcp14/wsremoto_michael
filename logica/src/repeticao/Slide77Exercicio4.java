...
public class Slide77Exercicio4 {
	...
	public static void main(String[] args) {
		 ...
		 * Ao terminar, o programa deverá exibir a pessoa mais velha, a pessoa mais nova, a quantidade de pessoas
        ...
        System.out.printf("%s é a(o) pessoa mais experiente com %d anos de idade;\n", nomeExperiente, idadeExperiente);
        System.out.printf("%s é a(o) pessoa mais jovem com %d anos de idade.\n", nomeJovem, idadeJovem);
