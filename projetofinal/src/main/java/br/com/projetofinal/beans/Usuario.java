...
public class Usuario {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY) //vai indicar que o valor id será gerado no BD
	@Column(name="id")
	private int id;
	...
	public void getAll (int id, String nome, String email, String senha, String foto) {
		//super();
		this.id = id;
		this.nome = nome;
		this.email = email;
